...
module.exports = class LeadsDBApi {
  static async create(data, options) {
    ...
    await leads.setActivities(data.activities || [], {
      transaction,
    });
  ...
  static async update(id, data, options) {
    ...
    if (data.activities !== undefined) {
      await leads.setActivities(data.activities, { transaction });
    }
  ...
  static async findBy(where, options) {
    ...
    output.activities = await leads.getActivities({
      transaction,
    });
  ...
  static async findAll(filter, options) {
    ...
    if (filter) {
      ...
      if (filter.activities) {
        const searchTerms = filter.activities.split('|');

        include = [
          {
            model: db.activities,
            as: 'activities_filter',
